...
/* ===== Robustness / downturn / cost-sensitivity (B2/B3/B4) =============== */
.rb-note{display:block;font-size:10.5px;color:var(--ink-mute,#8a8474);margin-top:2px}
.ccbar{position:relative;height:10px;background:var(--hair-2,#eee6d8);border-radius:5px;min-width:90px;overflow:hidden}
.ccbar i{position:absolute;left:0;top:0;bottom:0;border-radius:5px;display:block}
